...
const Footer = () => {
    return (<>
        <div className="py-[123px] px-[163px] bg-black font-montserrat">
            <div className='flex gap-[90px] pb-[20px]'>
            ...
            <div className='flex items-center justify-between'>
                ...
                <div className='flex items-center gap-[59px] text-[14px] font-montserrat text-white'>
