    ...
    <div className="w-[100%] overflow-x-hidden bg-background">
      ...
      <div className="font-montserrat bg-background items-center justify-center mx-[24px] mb-36">
        ...
        <div className=" text-center mb-20">
          ...
          <p className="md:mx-[140px]">
            Through research and development and mutual support, we believe that we can create a thriving startup ecosystem that benefits everyone involved, from entrepreneurs and investors to service providers and government agencies.  By fostering a culture of collaboration and open communication, we
